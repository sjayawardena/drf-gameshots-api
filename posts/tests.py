...
class PostListViewTests(APITestCase):
    ...
    def test_logged_in_user_can_create_post(self):
        self.client.login(username='simon', password='pass')
    ...
    class PostDetailViewTests(APITestCase):
        def setUp(self):
            simon = User.objects.create_user(username='simon', password='pass')
            brian = User.objects.create_user(username='brian', password='pass')
            Post.objects.create(
                owner=simon, title='a title', content='simons content'
            )
            Post.objects.create(
